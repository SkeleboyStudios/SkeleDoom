...
func (l *mapShader) Setup(w *ecs.World) error {
	var err error
...
func (l *mapShader) updateBuffer(ren *common.RenderComponent, space *common.SpaceComponent) {
...
func (l *mapShader) computeBufferSize(draw common.Drawable) int {
...
func (l *mapShader) generateBufferContent(ren *common.RenderComponent, space *common.SpaceComponent, buffer []float32) bool {
	w := space.Width
	h := space.Height
...
func (l *mapShader) Draw(ren *common.RenderComponent, space *common.SpaceComponent) {
...
func (l *mapShader) SetCamera(c *common.CameraSystem) {
	if l.cameraEnabled {
		l.camera = c
	}
}
